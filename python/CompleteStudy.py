...
class CompleteStudy():
    ...
    A set of bias studies for a given 

    """
    def __init__(self, 
        generator_model, # Model used to generate yields (with efficiency/mat interactions set, etc)
    ...
    def fit_physics_param(self, gamma_fitter, channel_num, name="default", quiet=False):
        ...
        for fi, f in enumerate(self.KL_amplitude_files):
            for pi, p in enumerate(self.param_sets):
                ...
                direct_physics_param, direct_physics_param_err, direct_physics_param_result = gamma_fitter.fit_from_result(direct_result)
